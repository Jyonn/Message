...
package cn.a6_79.message.wheel;

import java.util.LinkedList;
import java.util.List;

import cn.a6_79.message.R;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFCC1D1D,
			0x00CC1D1D, 0x00CC1D1D };
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0x00CC1D1D);
		}
	...
	public String getCurrentItemValue() {
		return ((StericWheelAdapter)getAdapter()).getStrContents()[getCurrentItem()];
	}
